        ...
        <div className="modal-section-body">
            ...
            <div className="m-2 p-4 py-1">
                <form onSubmit={e => { e.preventDefault(); addAdmin() }} className="flex items-center">
                    ...
                    <input type="submit" value="ADD ADMIN" className="btn bg-sky-600 text-white hover:text-white hover:bg-sky-700" />
                </form>
            </div>
        </div>
    </>
            ...
            <div className="m-2 p-4 border-t border-gray-400">
                ...
                <form onSubmit={e => { e.preventDefault(); sendBroadcast() }}>
                    ...
                    <div className="flex items-center">
                        ...
                        <input type="submit" value="SEND" className="btn bg-sky-600 text-white hover:text-white hover:bg-sky-700" />
                    </div>
                </form>
            </div>
        </div>
        ...
        <div className="modal-section-body">
            <div className="m-2 p-4 border-t border-gray-400">
                ...
                <form onSubmit={e => { e.preventDefault(); searchUsers() }} className="flex items-center">
                    ...
                    <input type="submit" value="SEARCH USERS" className="btn bg-sky-600 text-white hover:text-white hover:bg-sky-700" />
                </form>
                {userDetails.username.length > 0 && <form onSubmit={e => { e.preventDefault(); setPassword() }}>
                    ...
                    <div className="flex items-center">
                        ...
                        <input type="submit" value="SET PASSWORD" className="btn bg-sky-600 text-white hover:text-white hover:bg-sky-700" />
                    </div>
                </form>}
            </div>
        </div>

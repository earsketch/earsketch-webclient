            ...
            if (!uncalledFunctionLines.includes(lineNumber + 1)) {
                            ...
                            if (nodeToCheck._astname === "List" || nodeToCheck._astname === "BinOp" || nodeToCheck._astname === "BoolOp" || nodeToCheck._astname === "Compare") {
                                ...
                                for (var n = 0; n < allNamesWithin.length; n++) {
                                    ...
                                    if (otherVariable != null) {
                                        ...
                                        if (otherVariable.original || originality) {
                                            if (results[otherVariable.value] < 3) {
                                                results[otherVariable.value] = 3;
                                            }
                                            if (otherVariable.indexAndInput.input) {
                                                results.consoleInput = 3;
                                            }
                ...
                if (node._astname === "JSFor") {
                    ...
                    if (node.init != null) {
                        if (node.init._astname === "Assign") {
                            ...
                            if (initOrig) {
                                ...
                                //datatypes
                                typesWithinAssign.forEach(function(type) {
                                    if (results[type] < 3) { results[type] = 3; }
                                });
                                if (assignIn.input) {
                                    results.consoleInput = 3;
                                }
                    ...
                    if (anyOriginal) {
                            ...
                            if ('func' in testItem) {
                                if (originality) {
                                    ...
                                    if (testFunc != null) {
                                        ...
                                        //contained values
                                        if (testFunc.containedValue != null) {
                                            testFunc.containedValue.forEach(function(arg) {
                                                if(results[arg] < 3) {
                                                    results[arg] = 3;
                                                }
                                            });
                        ...
                        if (testItem._astname === "Name") {
                            ...
                            if (argVar != null) {
                                ...
                                if (originality || assignOriginal) {
                                    ...
                                    if (contained.length > 0) {
                                        contained.forEach(function(arg) {
                                            if(results[arg] < 3) { results[arg] = 3; }
                                        });
                                    }
                                }
                            }
                        ...
                        //datatypes
                        dataTypesIn.forEach(function(type) {
                            if (results[type] < 3) { results = 3; }
                        });
                        if (indexingIn.input) {
                            results.consoleInput = 3;
                        }

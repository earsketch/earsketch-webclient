...
//------------------------- RING MODULATOR ----------------------------------//
const RingmodNode = function (context: AudioContext) {
    //create the nodes we’ll use
    this.input = context.createGain()
    const output = context.createGain()
...
//------------------------- WAH-WAH ----------------------------------//
const WahNode = function (context: AudioContext) {
    //create the nodes we’ll use
    this.input = context.createGain()
    const output = context.createGain()
    this.bandpass = context.createBiquadFilter()
...
//------------------------- REVERB -------------------------//
const ReverbNode1 = function (context: AudioContext) {
    this.input = context.createGain()
    ...
    for (const i in effects) {
        ...
        if (effect.name == 'DELAY') {
            ...
            if (buildAudioNodeGraph.delayNodeCreatedFlag == 0) {
                DelayEffectNode = new (DelayNode as any)(context)
                if (buildAudioNodeGraph.firstNodeCreatedFlag != 0) {
        ...
        if (effect.name == 'PAN') {
            ...
            if (buildAudioNodeGraph.pannerNodeCreatedFlag == 0) {
                PannerEffectNode = new (PannerNode as any)(context)
                if (buildAudioNodeGraph.firstNodeCreatedFlag != 0) {

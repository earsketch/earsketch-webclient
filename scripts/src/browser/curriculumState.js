...
export const selectPageTitle = createSelector(
    ...
    (location, content) => {
        ...
        if (location.length === 1) {
            angular.element('[ng-controller="mainController as mainCtrl"]').scope().curriculumPageView(toc[location[0]].title)
            ...
            angular.element('[ng-controller="mainController as mainCtrl"]').scope().curriculumPageView(title)
            return title

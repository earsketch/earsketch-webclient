        ...
        <div className={`p-5 border-b border-r border-black ${theme === "light" ? "border-gray-500" : "border-gray-700"}`}>
            <div className="flex justify-between mb-4">
                <span
                    ...
                    onClick={() => { obj.details = !obj.details; forceUpdate(); if (FLAGS.SHOW_CAI) { addUIClick("api - read - " + obj.autocomplete) } }}
                >
                    {name}
                </span>
                <div className="h-8 flex">
                    <button
                        ...
                        onClick={() => { paste(name, obj); if (FLAGS.SHOW_CAI) { addUIClick("api - copy - " + name) } }}
                    >
                        <i className="icon icon-paste2" />
                    </button>
                    <button className="hover:bg-gray-200 active:bg-gray-300 h-full text-xl rounded-full pl-4 border border-gray-600 whitespace-nowrap" onClick={() => { obj.details = !obj.details; forceUpdate(); if (FLAGS.SHOW_CAI) { addUIClick("api - read - " + obj) } }}>

      ...
      <div className="w-full h-full">
        ...
        >
          <div
            ...
            style={
              bubbleActive && [5, 6, 7, 9].includes(bubblePage)
                ? { zIndex: 35 }
                : {}
            }
          >
          ...
          >
            <div id="devctrl">
              <div
                ...
                id="workspace"
                style={
                  bubbleActive && [3, 4, 9].includes(bubblePage)
                    ? { zIndex: 35 }
                    : {}
                }
              >
                ...
                <div
                  className={
                    (loading ? "hidden " : "") + "workstation h-full w-full"
                  }
                >
                  <DAW />
                </div>
            ...
            <div
              ...
              id="coder"
              style={
                bubbleActive && [1, 2, 9].includes(bubblePage)
                  ? { zIndex: 35 }
                  : {}
              }
            >
              ...
              <div className="grow h-full overflow-y-hidden">
                <div
                  className={
                    "h-full flex flex-col" + (numTabs === 0 ? " hidden" : "")
                  }
                >
          ...
          {!FLAGS.HIDE_CURRICULUM && (
            <div
              ...
              style={
                bubbleActive && [8, 9].includes(bubblePage)
                  ? { zIndex: 35 }
                  : {}
              }
            >
              {(showCai || FLAGS.UPLOAD_CAI_HISTORY) && (
                <div
                  className={
                    !showCai && FLAGS.UPLOAD_CAI_HISTORY ? "hidden" : "h-full"
                  }
                >

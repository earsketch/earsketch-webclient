        ...
        <form onSubmit={e => { e.preventDefault(); resetPassword() }}>
            <ModalBody>
                <label className="w-full text-sm">
                    ...
                    <input type="email" className="form-input w-full dark:bg-transparent placeholder:text-gray-300" name="email" placeholder={t("forgotPassword.email")} required autoComplete="off" value={email} onChange={e => setEmail(e.target.value)} autoFocus />
                </label>
            </ModalBody>

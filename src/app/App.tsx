...
async function postLogin(username: string) {
  ...
  userNotification.callbacks.addSharedScript = (id) =>
    addSharedScript(id, false);
...
const MiscActionMenu = () => {
  ...
  const links = [
    {
      nameKey: "whatsNew",
      linkUrl: "https://earsketch.gatech.edu/landing/#/releases",
    },
    {
      nameKey: "footer.teachers",
      linkUrl: "https://earsketch.gatech.edu/landing/#/contact",
    },
    {
      nameKey: "footer.help",
      linkUrl: "https://earsketch.gatech.edu/landing/#/releases",

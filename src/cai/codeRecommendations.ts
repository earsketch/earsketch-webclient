...
export const CAI_RECOMMENDATIONS = {
    ...
    goal: {
        id: 11,
        examplePY: "if you need extra help, we can check the API or the curriculum for examples",
        exampleJS: "if you need extra help, we can check the API or the curriculum for examples",

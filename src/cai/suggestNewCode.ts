...
const suggestionContent: SuggestionContent = {
    0: {
        ...
        explain: "storing our sound samples in a variable lets us use that as a name, and it makes it easier to try different sounds",
        examplePY: "instead of\n\nfitMedia(HIPHOP_SYNTHPLUCKLEAD_005, 1, 1, 5)\nfitMedia(HIPHOP_SYNTHPLUCKLEAD_005, 1, 9, 13)\n\nwe could write\n\nsynth1 = HIPHOP_SYNTHPLUCKLEAD_005\nfitMedia(synth1, 1, 1, 2)\nfitMedia(synth1, 1, 9, 13)",
    ...
    8: {
        ...
        explain: "[LINK|custom function]s can help us make sections of music without having to write too many fitMedia() calls",
        examplePY: "def sectionA(start, end):\n    fitMedia(melody2, 1, start, end)\n    fitMedia(brass1, 2, start, end)\n    setEffect(2, VOLUME, GAIN, -20, start, -10, end)\nsectionA(1,5)",
        exampleJS: "function sectionA(start, end) {\n    fitMedia(melody2, 1, start, end);\n    fitMedia(brass1, 2, start, end);\n    setEffect(2, VOLUME, GAIN, -20, start, -10, end);\n}\nsectionA(1,5);",
    },
    10: {
        id: 210,
    ...
    11: {
        ...
        explain: "using readInput() lets us ask the user for input, which we can then pair with a [LINK|conditional statement] to change things about our song based on what the user inputs",
        examplePY: "clipNumber = readInput(\"Type a clip number between 10 and 46: \")\ndubstepClip = \"DUBSTEP_BASS_WOBBLE_0\"\n    finalClip = dubstepClip + clipNumber\n\n    fitMedia(finalClip, 1, 1, 5)",
        exampleJS: "var clipNumber = readInput(\"Type a clip number between 10 and 46: \");\nvar dubstepClip = \"DUBSTEP_BASS_WOBBLE_0\";\n    var finalClip = dubstepClip + clipNumber;\n\n    fitMedia(finalClip, 1, 1, 5);",
    },
    13: {
        id: 213,

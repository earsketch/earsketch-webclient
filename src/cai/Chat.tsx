        ...
        <div id="chat-footer">
            ...
            <div className="flex items-center">
                {wizard
                    ...
                    />
                    : <input type="text" className="py-1.5 px-3 w-2/3 mx-1.5" placeholder="Send a message" value={inputText} onChange={e => setInputText(e.target.value)} onKeyDown={e => handleKeyDown(e)} style={{ float: "left", color: "black", backgroundColor: "lightgray" }}></input>}
